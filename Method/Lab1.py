...
def y(x):
    try:
        y = sin(x) + cos((2**0.5)*x) + sin((3**0.5)*x)
        return sin(x) + cos((2**0.5)*x) + sin((3**0.5)*x) 
    except:
        return None
...
print("")
print(dichotomy_method(-2,4, 0.005))

print(Fibonacci(-2,4, 0.005))
print(parabola(-2,4, 0.005))
print("")
print(golden_ratio(-2,4, 0.005)) 
print(Brenta(-2,4, 0.005))
